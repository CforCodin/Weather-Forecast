...
lable_6 = Label(root,text="Humidity : ",width = 20,bg='white',font=("bold",10),fg='blue')
lable_6.place(x=62,y=280)
...
lable_hum = Label(root,text="...",width = 5,bg='white',font=("bold",10),fg='blue')
lable_hum.place(x=192,y=280)
...
def getTemp():
    ...
    api_key = "ebe9e3e5669b1fce654dff10f5023b78"
...
# module response get
    ...
    if["cod"] !='404':
        ...
        lable_hum.configure(text=current_humidity)
    else:
